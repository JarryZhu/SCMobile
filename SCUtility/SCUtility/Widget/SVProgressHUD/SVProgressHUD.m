...
{
    [[SVProgressHUD sharedView] showInfo:string duration:2.0];
}
...
- (void)setStatus:(NSString *)string {
    ...
    if (isTextCenter) {
       	self.stringLabel.center = CGPointMake(CGRectGetWidth(self.hudView.bounds)/2, CGRectGetHeight(self.hudView.bounds)/2);
    }
